...
var cardArray = exports.cardArray = ['Привет, мир!', 'Это текст для генерации.', 'Вставь меня в карточку!', 'Генерация текста - это весело!'];
...
},{"./tabs":10}],6:[function(require,module,exports){
"use strict";
...
},{"./calculate":1,"./cardText":3,"./dice":4,"./init-tabs":5,"./initMenuAboutGameScroll":6,"./initMenuIndexScroll":7,"./management-swiper":9}],9:[function(require,module,exports){
"use strict";
