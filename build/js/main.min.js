...
exports.initializeCalculator = initializeCalculator;
function initializeCalculator() {
  var inputField = document.getElementById('inputField');
  var calculatorAllButtons = document.querySelectorAll('button');
  var generateButton = document.getElementById('generateButton');
  var rollButton = document.getElementById('rollButton'); // Предположим, что у нас есть кнопка с идентификатором 'exceptButton'

  var buttons = Array.from(calculatorAllButtons).filter(function (button) {
    return button !== generateButton && button !== rollButton;
  });
...
var cardArray = exports.cardArray = ['Вам вернули налоговый вычет! Получите на свой счет 100 бан.', 'Вам была одобрена государственная программа по аннулированию кредита. Программа распространяется только на действующие текущие кредиты игрока, получившего данную карту. ', 'У вас была обнаружена задолженность по налогам! Заплатите государству 100 бан.', 'Государство помогает вам с материалами для строительства! Получите 1 фасад здания бесплатно.', 'Вам помогли с ранним оформлением «Субсидии на развитие». Отправляйтесь на любое поле «Субсидия на развитие» и получите 300 бан. ', 'К вам прилетели иностранные гости и оплатили сниженную ренту за посещения ваших кварталов! Получите по 5 бан за каждый фасад и крышу здания, построенные на ваших кварталах. ', 'Пожарная инспекция обнаружила недопустимые нарушения в ваших зданиях! Заплатите по 5 бан за каждый фасад и крышу здания, построенные на ваших кварталах. ', 'На территории ваших кварталов произошло землетрясение, которое повредило коммуникации! Заплатите по 10 бан за каждый ваш фундамент. ', 'Вы получили инновационный проект, который позволяет сэкономить на ваших фундаментах! Получите по 10 бан за каждый ваш фундамент. ', 'У вас была обнаружена задолженность по налогам! Заплатите государству 70 бан.', 'Вам вернули налоговый вычет! Получите на свой счет 70 бан.', 'Вы получили одобрение по государственной программе «Нет процентам по кредиту», вы можете не оплачивать оставшиеся проценты по кредиту. Программа распространяется только на действующие текущие кредиты игрока, получившего данную карту. ', 'В вас инвестировало население! Получите 50 бан.', 'Пора выплачивать купоны по облигациям! Заплатите 50 бан.', 'Вам помогли с ранним оформлением «Субсидии на развитие». Отправляйтесь на любое поле «Субсидия на развитие» и получите 300 бан. ', 'Вам вернули налоговый вычет! Получите на свой счет 30 бан.', 'У вас была обнаружена задолженность по налогам! Заплатите государству 30 бан.', 'Конкуренты вашей фирмы оплатили ренту за посещения ваших кварталов! Получите по 8 бан за каждый фасад и крышу здания, построенные на ваших кварталах. ', 'Градостроительный комитет обнаружила грубые нарушения в ваших зданиях! Заплатите по 8 бан за каждый фасад и крышу здания, построенные на ваших кварталах. ', 'Государство помогает вам с освоением новых кварталов! Получите 1 любой незанятый квартал бесплатно.'];
...
var _cardArray = require("./card-array");
function generateText() {
  ...
  var texts = _cardArray.cardArray;
  var randomIndex = Math.floor(Math.random() * texts.length);
  var randomText = texts[randomIndex];

  // Создаем новый элемент для текста
  var newText = document.createTextNode(randomText);
...
},{"./card-array":2}],4:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.rollDiceSix = rollDiceSix;
function rollDiceSix() {
  document.getElementById('rollButton').addEventListener('click', function () {
    var numSidesValue = document.getElementById("numSidesValue").textContent;
    var numSides = parseInt(numSidesValue);
    var roll1 = Math.floor(Math.random() * numSides) + 1;
    var roll2 = Math.floor(Math.random() * numSides) + 1;
...
},{"./tabs":13}],6:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initMenuAboutGameScroll = void 0;
var buttonMenuAboutUs = document.querySelector('.menu__link--about-us');
var buttonMenuOrder = document.querySelector('.menu__link--order');
var buttonMenuAboutUsFooter = document.querySelector('.footer__link--about-us');
var buttonMenuOrderFooter = document.querySelector('.footer__link--order');
var initMenuAboutGameScroll = exports.initMenuAboutGameScroll = function initMenuAboutGameScroll() {
...
exports.initMenuIndexScroll = void 0;
var buttonMenuRules = document.querySelector('.menu__link--rules');
var buttonMenuStartGame = document.querySelector('.menu__link--start-game');
var buttonMenuRulesFooter = document.querySelector('.footer__link--rules');
var buttonMenuStartGameFooter = document.querySelector('.footer__link--start-game');
var initMenuIndexScroll = exports.initMenuIndexScroll = function initMenuIndexScroll() {
  if (document.querySelector('.management')) {
    buttonMenuRules.addEventListener('click', function () {
      document.querySelector('.management').scrollIntoView({
        behavior: 'smooth'
      });
    });
  }
...
exports.initTabsScrollBargaining = void 0;
var buttonTabsBargaining = document.querySelector('.management__link--bargaining');
var initTabsScrollBargaining = exports.initTabsScrollBargaining = function initTabsScrollBargaining() {
  if (document.querySelector('.management__swiper-slide--bargaining')) {
    buttonTabsBargaining.addEventListener('click', function () {
      document.querySelector('.management__swiper-slide--bargaining').scrollIntoView({
        behavior: 'smooth'
      });
    });
  }
...
exports.initTabsScrollCredit = void 0;
var buttonTabsCredit = document.querySelector('.management__link--credit');
var initTabsScrollCredit = exports.initTabsScrollCredit = function initTabsScrollCredit() {
  if (document.querySelector('.management__swiper-slide--credit')) {
    buttonTabsCredit.addEventListener('click', function () {
      document.querySelector('.management__swiper-slide--credit').scrollIntoView({
        behavior: 'smooth'
      });
    });
  }
...
exports.initTabsScrollPreparation = void 0;
var buttonTabsPreparation = document.querySelector('.management__link--preparation');
var initTabsScrollPreparation = exports.initTabsScrollPreparation = function initTabsScrollPreparation() {
  if (document.querySelector('.management__swiper-slide--preparation')) {
    buttonTabsPreparation.addEventListener('click', function () {
      document.querySelector('.management__swiper-slide--preparation').scrollIntoView({
        behavior: 'smooth'
      });
    });
  }
...
var _managementSwiper = require("./management-swiper");
var _cardText = require("./cardText");
var _calculate = require("./calculate");
var _dice = require("./dice");
var _initMenuIndexScroll = require("./initMenuIndexScroll");
var _initMenuAboutGameScroll = require("./initMenuAboutGameScroll");
var _initTabsScrollBargaining = require("./initTabsScrollBargaining");
var _initTabsScrollPreparation = require("./initTabsScrollPreparation");
var _initTabsScrollCredit = require("./initTabsScrollCredit");
window.addEventListener('DOMContentLoaded', function () {
  ...
  if (calculatorElement) {
    (0, _cardText.generateText)();
    (0, _calculate.initializeCalculator)();
    (0, _dice.rollDiceSix)();
  }
  ...
  (0, _managementSwiper.initManagementSwiper)();
  (0, _initMenuIndexScroll.initMenuIndexScroll)();
  (0, _initMenuAboutGameScroll.initMenuAboutGameScroll)();
  (0, _initTabsScrollBargaining.initTabsScrollBargaining)();
  (0, _initTabsScrollPreparation.initTabsScrollPreparation)();
  (0, _initTabsScrollCredit.initTabsScrollCredit)();
...
},{"./calculate":1,"./cardText":3,"./dice":4,"./init-tabs":5,"./initMenuAboutGameScroll":6,"./initMenuIndexScroll":7,"./initTabsScrollBargaining":8,"./initTabsScrollCredit":9,"./initTabsScrollPreparation":10,"./management-swiper":12}],12:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initManagementSwiper = void 0;
var _swiper = _interopRequireDefault(require("../js/vendor/swiper.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var managementSwiper = document.querySelector('.management__swiper');
var initManagementSwiper = exports.initManagementSwiper = function initManagementSwiper() {
  if (managementSwiper) {
    (function () {
      return new _swiper.default('.management__swiper', {
...
},{"../js/vendor/swiper.js":14}],13:[function(require,module,exports){
"use strict";
